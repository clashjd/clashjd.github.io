...
- **带宽上限**：10Mbps  
- **适合人群**：轻度浏览、简单加速  
- **购买链接**：[立即抢购 0.5 元套餐](http://use.clashgomai.xyz/#/plans/0.5)  
...
- **带宽上限**：50Mbps  
- **适合人群**：视频/游戏加速、海外社交  
- **购买链接**：[立即抢购 6 元套餐](http://use.clashgomai.xyz/#/plans/6)  
...
- **节点**：随机分配  
- **申请地址**：  
  1. 访问 [星空云免费试用](http://use.clashgomai.xyz/#/free)  
  2. 填写邮箱，获取试用订阅链接  
...
- 🔗 官网地址：[http://use.clashgomai.xyz/](http://use.clashgomai.xyz/)  
...
## 如何购买与支付
1. 打开 [星空云官网](http://use.clashgomai.xyz/)。  
...
- 检查客户端网络权限是否开启。  
- 如仍失败，联系客服邮箱 support@clashgomai.xyz。
